...
function drawOrganizationChart(params) {
  ...
  function update(source, param) {
    ...
    function tooltipContent(item) {
      ...
      strVar += '  <li class=\"tool-hobby\">'+item.userData.sponsor+'<br\/>Sponsor<\/li>';
      strVar += '  <li class=\"tool-hobby\">'+item.userData.parent+'<br\/>Parent<\/li>';
      strVar += '  <li class=\"tool-hobby\">'+item.userData.position+'<br\/>Position<\/li>';
      strVar += '  <\/ul><\/div>';
      strVar += '  <div class=\"tool-user-info\">';
      strVar += '  <div class=\"tool-followers\">';
      strVar += '  <h3>'+item.userData.total_earning+'<\/h3><small>Earning<\/small><\/div>';
      strVar += '  <div class=\"tool-following\"><h3>'+item.userData.downlines+'<\/h3> <small>Ref...<\/small><\/div>';
      strVar += '  <div class=\"tool-number-of-posts\"><h3>'+item.userData.total_widral+'<\/h3> <small>Withdraw<\/small> <\/div>';
      strVar += '  <\/div>';
